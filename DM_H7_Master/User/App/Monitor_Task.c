...
{
    _ui_update_g_group_cap_0();      osDelay(40);
    _ui_update_g_group_shoot_0();    osDelay(40);
    _ui_update_g_group_static_0();   osDelay(40);
    _ui_update_g_group_static_1();   osDelay(40);
    _ui_update_g_group_status_0();   osDelay(40);
    _ui_update_g_group_status_1();   osDelay(40);
    _ui_init_g_group_vision_0();   osDelay(40);
}